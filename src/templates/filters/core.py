...
from templates.six import iteritems, string_types

from templates import errors
from templates.parsing.yaml.dumper import TemplatesDumper
from templates.utils.hashing import md5s, checksum_s
from templates.utils.unicode import unicode_wrap, to_unicode
from templates.utils.vars import merge_hash
...
def to_yaml(a, *args, **kw):
    ...
    transformed = yaml.dump(a, Dumper=TemplatesDumper, allow_unicode=True, **kw)
    return to_unicode(transformed)

def to_nice_yaml(a, *args, **kw):
    '''Make verbose, human readable yaml'''
    transformed = yaml.dump(a, Dumper=TemplatesDumper, indent=4, allow_unicode=True, default_flow_style=False, **kw)
    return to_unicode(transformed)
...
def regex_search(value, regex, *args, **kwargs):
    ...
    for arg in args:
        if arg.startswith('\\g'):
            ...
            raise errors.TemplatesFilterError('Unknown argument')
